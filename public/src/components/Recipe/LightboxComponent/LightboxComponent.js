...
const LightboxComponent = ({ preSignedUrls }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [preSignedUrls?.map((url, i) => ((0, jsx_runtime_1.jsx)(ImageSkeletonLoader_1.default, { openLightBox: () => triggerLightbox(i), url: url }, url))), (0, jsx_runtime_1.jsx)(react_spring_lightbox_1.default, { isOpen: isOpen, onPrev: gotoPrevious, onNext: gotoNext, images: images, currentIndex: currentImageIndex, onClose: onClose, renderHeader: () => ((0, jsx_runtime_1.jsx)(material_1.Box, { padding: 1, textAlign: "right", marginTop: "64px", children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { color: "info", onClick: onClose, children: (0, jsx_runtime_1.jsx)(CloseRounded_1.default, {}) }) })), renderPrevButton: () => ((0, jsx_runtime_1.jsx)(material_1.Button, { color: "info", 
                    // disabled={!canPrev}
                    onClick: gotoPrevious, children: (0, jsx_runtime_1.jsx)(ArrowBackIosNewRounded_1.default, {}) })), renderNextButton: () => ((0, jsx_runtime_1.jsx)(material_1.Button, { color: "info", 
                    // disabled={!canNext}
                    onClick: gotoNext, children: (0, jsx_runtime_1.jsx)(ArrowForwardIosRounded_1.default, {}) })), style: { background: `rgba(29,29,29, 0.95` } })] }));
};
