...
class RecipeDialog extends React.Component<any, any> {
  ...
  render () {
    const { loading, recipeValid, tags, category, recipe_title_edit, ingredients_edit, directions_edit } = this.state
    ...
    return (
      <Dialog
        ...
        <DialogContent >
          <h3>Title</h3>
          <ReactQuill defaultValue={recipe_title_edit} onChange={this.handleModelChange}/>
          <h3>Ingredients</h3>
          <ReactQuill defaultValue={ingredients_edit} onChange={this.handleModelChangeIngredients}/>
          <h3>Directions</h3>
          <ReactQuill defaultValue={directions_edit} onChange={this.handleModelChangeDirections}/>
